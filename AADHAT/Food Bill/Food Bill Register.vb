Public Class Food_Bill_Register
    ...
    Private Sub Item_Register_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
        mskFromDate.Focus() : rowColumsSimple()
    End Sub
    ...
    Private Sub rowColums()
        ...
        dg1.Columns(2).Name = "Bill No" : dg1.Columns(2).Width = 70
        dg1.Columns(3).Name = "Service" : dg1.Columns(3).Width = 100
        dg1.Columns(4).Name = "SN" : dg1.Columns(4).Width = 50
        dg1.Columns(5).Name = "Item Name" : dg1.Columns(5).Width = 170
        dg1.Columns(6).Name = "Qty" : dg1.Columns(6).Width = 60
        ...
        dg1.Columns(10).Name = "Taxable" : dg1.Columns(10).Width = 70
        dg1.Columns(11).Name = "Tax" : dg1.Columns(11).Width = 70
        dg1.Columns(12).Name = "R.off" : dg1.Columns(12).Width = 60
        dg1.Columns(13).Name = "Total" : dg1.Columns(13).Width = 80
        dg1.Columns(14).Name = "Cash" : dg1.Columns(14).Width = 80
        dg1.Columns(15).Name = "Change" : dg1.Columns(15).Width = 80
    End Sub
    Private Sub rowColumsSimple()
        dg1.ColumnCount = 16
        dg1.Columns(0).Name = "ID" : dg1.Columns(0).Visible = False
        dg1.Columns(1).Name = "Date" : dg1.Columns(1).Width = 80
        dg1.Columns(2).Name = "Bill No" : dg1.Columns(2).Width = 70
        dg1.Columns(3).Name = "Service" : dg1.Columns(3).Width = 100
        dg1.Columns(4).Name = "SN" : dg1.Columns(4).Visible = False
        dg1.Columns(5).Name = "Account Name" : dg1.Columns(5).Width = 220
        dg1.Columns(6).Name = "Qty" : dg1.Columns(6).Width = 60
        dg1.Columns(7).Name = "Disc" : dg1.Columns(7).Visible = False
        dg1.Columns(8).Name = "Basic" : dg1.Columns(8).Width = 140
        dg1.Columns(9).Name = "Disc" : dg1.Columns(9).Width = 60
        dg1.Columns(10).Name = "Taxable" : dg1.Columns(10).Width = 70
        dg1.Columns(11).Name = "Tax" : dg1.Columns(11).Width = 70
        dg1.Columns(12).Name = "R.off" : dg1.Columns(12).Width = 60
    ...
    Sub calc()
        ...
        txtTotTaxable.Text = Format(0, "0.00") : txtTotChange.Text = Format(0, "0.00")
    ...
    Private Sub retriveSimple(Optional ByVal condtion As String = "")
        dg1.Columns.Clear() : dg1.Rows.Clear()
        rowColumsSimple()
        Dim dt As New DataTable
        dt = clsFun.ExecDataTable("Select * from Vouchers Where EntryDate Between '" & CDate(mskFromDate.Text).ToString("yyyy-MM-dd") & "' And '" & CDate(MsktoDate.Text).ToString("yyyy-MM-dd") & "' and transtype='Food Bill' " & condtion & " Group by ID  order by ID ")
            ...
            If dt.Rows.Count > 0 Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    With dg1.Rows(i)
                        ...
                        .Cells(6).Value = Format(Val(dt.Rows(i)("TotQty").ToString()), "0.00")
                        .Cells(8).Value = Format(Val(dt.Rows(i)("TotalBasicAmt").ToString()), "0.00")
                        .Cells(9).Value = Format(Val(dt.Rows(i)("TotalDiscAmt").ToString()), "0.00")
                        .Cells(10).Value = Format(Val(dt.Rows(i)("TotalTaxableAmt").ToString()), "0.00")
                        .Cells(11).Value = Format(Val(dt.Rows(i)("TotalTaxAmt").ToString()), "0.00")
        ...
        End Try
        lblTotal.Visible = True : lblTotal.Text = "Total Food Bills : " & dg1.Rows.Count
    ...
    Private Sub retrive(Optional ByVal condtion As String = "")
        ...
        rowColums()
        Dim dt As New DataTable
        dt = clsFun.ExecDataTable("Select * From Trans as t Inner  join Vouchers V on V.id=t.VoucherID Where EntryDate Between '" & CDate(mskFromDate.Text).ToString("yyyy-MM-dd") & "' And '" & CDate(MsktoDate.Text).ToString("yyyy-MM-dd") & "' and V.transtype='Food Bill' " & condtion & "  order by ID ")
        Dim vchid As Integer = 0
        Try
            If dt.Rows.Count > 0 Then
                dg1.Rows.Clear()
                For i = 0 To dt.Rows.Count - 1
                    ...
                    With dg1.Rows(i)
                        ...
                        Else
                            ...
                            .Cells(3).Value = dt.Rows(i)("ServiceType").ToString()
                            .Cells(12).Value = Format(Val(dt.Rows(i)("Roundoff").ToString()), "0.00")
                            .Cells(13).Value = Format(Val(dt.Rows(i)("TotalAmt").ToString()), "0.00")
                            .Cells(14).Value = Format(Val(dt.Rows(i)("TotalCashAmt").ToString()), "0.00")
                            .Cells(15).Value = Format(Val(dt.Rows(i)("TotalBalAmt").ToString()), "0.00")
                        End If
    ...
    Private Sub dg1_KeyDown(sender As Object, e As KeyEventArgs) Handles dg1.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            Food_Bill.Show()
            Food_Bill.FillControls(tmpID)
            If Not Food_Bill Is Nothing Then
    ...
    Private Sub btnShow_Click(sender As Object, e As EventArgs) Handles btnShow.Click
        If ckItemDetails.Checked = True Then
            retrive()
