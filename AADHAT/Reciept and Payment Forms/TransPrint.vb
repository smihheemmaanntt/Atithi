...
Public Class TransPrint
    ...
    Sub printReport()
        ...
        Try
            ...
            Rpt.Load(Application.StartupPath & "\trans.rpt")
        ...
        End Try
    End Sub
    'Private Sub TransPrint_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    '    Me.Dispose()
    'End Sub
    Private Sub TransPrint_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then Me.Close()
    End Sub
    Private Sub TransPrint_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        me.Top = 0
        Me.Left = 0
