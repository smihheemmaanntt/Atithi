    ...
    Private Sub retrive(Optional ByVal condtion As String = "")
        ...
        For i = 0 To dt.Rows.Count - 1
            ...
            With dg1.Rows(i)
                ...
                .Cells(2).Value = clsFun.ExecScalarStr("Select EntryDate ||' : ' ||amount  As Remark  From Ledger Where DC='D' and AccountID='" & Val(dt.Rows(i)("ID").ToString()) & "' And Entrydate <='" & CDate(mskEntryDate.Text).ToString("yyyy-MM-dd") & "' Order by EntryDate Desc Limit 1 ")
